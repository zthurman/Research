...
def ballistix(x,t, gamma = 0.25, m = 0.028, D = 0.0056, g = 9.8):
    c = gamma*(D**2)
    return np.array([ -c*sqrt(x[0]**2 + x[1]**2)*x[0], \
                    -m*g - c*sqrt(x[0]**2 + x[1]**2)*x[1]])

def do_tplot():
    X = RK4(x0 = np.array([0,444]), t1 = 2500,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 2500
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
...
def do_tplot():
    X = RK4(x0 = np.array([0,429]), t1 = 1000,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 1000
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
...
def do_tplot():
    X = RK4(x0 = np.array([0,309]), t1 = 1000,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 1000
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
...
def do_tplot():
    X = RK4(x0 = np.array([0,900.2]), t1 = 1000,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 1000
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
...
def do_tplot():
    X = RK4(x0 = np.array([0,396.2]), t1 = 1000,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 1000
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
...
def do_tplot():
    X = RK4(x0 = np.array([0,452.93]), t1 = 110,dt = 0.1, ng = ballistix)
    t0 = 0
    t1 = 110
    dt = 0.1
    tsp = np.arange(t0, t1, dt)
